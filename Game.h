...
private:
	...
	// declare 2-D array of type char called a_cGrid 
	// the number of rows in the array is k_nGridRowsDefault and the number of columns is k_nGridColumnsDefault.
	char a_cGrid [2];

	int m_nGridRows;                                           
	int m_nGridColumns;                                        

	// Row number target boat positioned in
	int m_iRowBoat;                                        
	// Column number target boat positioned in    
	int m_iColumnBoat;                                        
	// Number of torpedoes remaning in magazine
	int m_nTorpedoes;                                         
